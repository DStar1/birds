...
ex -sc '61c|sh ~/.ft_project/gen_project.sh $DIRECTORY $PROJECT' -cx ~/.ft_project/ft_project.sh
...
ex -sc '77c|[Yy]* ) sh ~/.ft_project/gen_makefile.sh $DIRECTORY $PROJECT $LIBFT; break;;' -cx ~/.ft_project/ft_project.sh
ex -sc '87c|[Yy]* ) sh ~/.ft_project/gen_author.sh $DIRECTORY; break;;' -cx ~/.ft_project/ft_project.sh
ex -sc '97c|[Yy]* ) sh ~/.ft_project/gen_gitignore.sh $DIRECTORY; break;;' -cx ~/.ft_project/ft_project.sh
ex -sc '107c|[Yy]* ) sh ~/.ft_project/gen_readme.sh $DIRECTORY $PROJECT; break;;' -cx ~/.ft_project/ft_project.sh

# Generate Header!!!
ex -sc '29c|sh ~/.ft_project/generate_header.sh "$PROJECT.c" "$DIRECTORY/srcs/main.c" "c"' -cx ~/.ft_project/gen_project.sh
ex -sc '40c|sh ~/.ft_project/generate_header.sh "$PROJECT.h" "$DIRECTORY/includes/${PROJECT}.h" "c"' -cx ~/.ft_project/gen_project.sh
ex -sc '24c|sh ~/.ft_project/generate_header.sh "Makefile" "$DIRECTORY/Makefile" "script"' -cx ~/.ft_project/gen_makefile.sh
ex -sc '72c|sh ~/.ft_project/generate_header.sh "Makefile" "$DIRECTORY/Makefile" "script"' -cx ~/.ft_project/gen_makefile.sh
